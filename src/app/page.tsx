...
const BoardPageContent = () => {
  ...
  return (
    <div className="container mx-auto p-4 pt-6 flex flex-col flex-grow">
      <div className={cn(
        "flex-grow",
        isMobile ? "grid grid-cols-1" : "md:grid md:grid-cols-2"
      )}>
        <div className={cn(
        ...
        {isMobile ? (
          ...
          selectedPost ? (
            <div className="md:col-span-1 flex flex-col md:border-l md:border-border md:pl-4">
              {renderPostDetailPanel()}
            </div>
          ) : (
            <div className="hidden md:flex md:col-span-1 flex-col items-center justify-center p-8 border rounded-lg bg-card/50 text-muted-foreground sticky top-20 h-[calc(100vh-6.5rem)] max-h-[calc(100vh-6.5rem)] md:border-l md:border-border md:pl-4">
