...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg", // Base styles without transition/animation
  {
    variants: {
      side: {
      ...
      disableAnimation: {
        true: "", // No animation classes if true
        false: "transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500", // Base animation classes if false
      }
    },
    compoundVariants: [ // Slide animations only apply if disableAnimation is false
      {
        side: "top",
